...
// If running a test, debug outputs are associated with each test step and
// printed as part of the "unsuccessful test" output. Otherwise, debug outputs
// go to stderr.
void debug_str(std::string_view message);

template <typename... Args>
void debug(std::format_string<Args...> fmt [[maybe_unused]],
